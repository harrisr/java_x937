...
public class TimeFieldTest extends TestCase {
	...
	protected void setUp() {
		try {
			field = new GenericNField(new Position(1,4));
			field.setFieldData(EasternStandardTime.getCurrentTimeInEST());
		} catch (Exception e) {
			fail(e.getMessage());
		}
	}
	...
	public void testDateLoaded() throws Exception {
		String estTime = field.getFieldData();
