...
import org.cdgsoftware.icl.field.type.Type_Binary;
 ...
 */
public class GenericBinaryField extends Field {
     ...
     */
    public GenericBinaryField(Position position, Validator fieldValidator, String fieldData) throws ICLException {
        initialize();
        this.position = position;
     ...
     */
    public GenericBinaryField(Position position, String fieldName) {
        initialize();
        this.position = position;
     ...
     * @throws ICLException the ICL exception
     */
    public GenericBinaryField(Position position, Validator fieldValidator, String fieldData, String fieldName)
            throws ICLException {
        initialize();
        this.fieldName = fieldName;
        this.position = position;
	...
	protected void initialize() {
		this.fieldName = "Generic Binary Field";
		this.fieldType = Type_Binary.INSTANCE;
