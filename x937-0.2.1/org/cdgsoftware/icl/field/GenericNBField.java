 ...
 */
public class GenericNBField extends Field {
     ...
     */
    public GenericNBField(Position position) {
        initialize();
     ...
     */
    public GenericNBField(Position position, Validator fieldValidator, String fieldData) throws ICLException {
        initialize();
        this.position = position;
     ...
     */
    public GenericNBField(Position position, String fieldName) {
        initialize();
        this.position = position;
     ...
     * @throws ICLException the ICL exception
     */
    public GenericNBField(Position position, Validator fieldValidator, String fieldData, String fieldName)
            throws ICLException {
        initialize();
        this.fieldName = fieldName;
        this.position = position;
    ...
    protected void initialize() {
        this.fieldName = "Generic Numeric Blank Field";
        this.fieldType = Type_NB.INSTANCE;
