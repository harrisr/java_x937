 ...
 */
public class GenericAField extends Field {
     ...
     */
    public GenericAField(Position position, Validator fieldValidator, String fieldData) throws ICLException {
        initialize();
        this.position = position;
     ...
     */
    public GenericAField(Position position, String fieldName) {
        initialize();
        this.position = position;
     ...
     * @throws ICLException the ICL exception
     */
    public GenericAField(Position position, Validator fieldValidator, String fieldData, String fieldName)
            throws ICLException {
        initialize();
        this.fieldName = fieldName;
        this.position = position;
	...
	protected void initialize() {
		this.fieldName = "Generic Alphabetic Field";
		this.fieldType = Type_Alphabetic.INSTANCE;
